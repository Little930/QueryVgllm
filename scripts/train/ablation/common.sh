...
# Root directory for offline npz files: {FEATURE_DIR}/{scene_id}/vggt.npz
# Generated by: python scripts/extract_vggt_features.py --output_dir $FEATURE_DIR
FEATURE_DIR="data/media/scannet/posed_images_3d_feature_vggt"
